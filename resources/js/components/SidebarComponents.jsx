...
export function SidebarItems({ children, className = "", ...props }) {
    return (
        <div
            className={`flex flex-col items-center p-0 gap-2 w-full h-fit ${className}`}
            {...props}
        >
            {children}
        </div>
...
export function SidebarDivider({ className = "", ...props }) {
    return (
        <hr
            className={`w-full border-t border-[var(--color-line-1px)]${className}`}
            {...props}
        />
    );
}
...
export function SidebarIcon({ children, className = "", ...props }) {
    return (
        <div
            className={`flex items-center justify-center w-8 h-8 text-blue-2 ${className}`}
            {...props}
        >
            {children}
        </div>
