export default function CartItem({ item, formatRupiah, onUpdate, onRemove }) {
    return (
        <div className="flex items-center gap-3 bg-white p-3 rounded-xl border border-low-white shadow-sm hover:border-blue-2 transition-colors">
            <div className="flex-1 min-w-0 pl-1">
                <h4 className="text-sm font-semibold text-dark truncate leading-tight mb-1">
                    {item.product.name}
                </h4>
                <div className="text-xs text-blue-2 font-bold">
