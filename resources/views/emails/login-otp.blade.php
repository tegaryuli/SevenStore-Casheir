...
<body style="font-family: sans-serif; background-color: #f3f4f6; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 60px 20px; border-radius: 8px;">
        <h2 style="color: #333333; margin-top: 0;">Kode OTP Login Anda</h2>
        <p style="color: #666666;">Gunakan kode berikut untuk menyelesaikan proses login Anda.</p>
